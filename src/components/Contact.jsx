      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {contactInfo.map((info, index) => (
            <div
              key={index}
              className="bg-dark-300 rounded-2xl p-6 text-center hover:bg-dark-400 transition duration-300 transform"
            >
              {/* Icon */}
              ...
              {info.link ? (
                <a
                  href={info.link}
                  className="text-gray-300 hover:text-purple transition duration-300 break-all"

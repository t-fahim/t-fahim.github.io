      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-start gap-12">
        ...
        >
          <div className="rounded-2xl px-4 pt-0">
            <h3 className="text-2xl font-semibold mb-6 lg:text-right">
              Education
            </h3>
            <div className="mx-auto">
              <div className="space-y-12">
                {education.map((data, index) => (
                  <div
                    key={index}
                    className="relative pl-12 cursor-pointer hover:-translate-y-2 transition-all duration-300"
                  >
        ...
        >
          <div className="rounded-2xl px-4 pt-0">
            ...
            <p className="text-gray-300 mb-6">
              I am an undergraduate Bioinformatics Engineering student with a
              deep interest in coding. My journey into technology began when I
              received my first laptop during COVID-19 period, which sparked my
              curiosity and love for programming & Linux OS. This passion led me
              to choose Bioinformatics Engineering, a challenging and innovative
              field that bridges technology and biology.
            </p>
            <p className="text-gray-300 mb-6">
              When I'm not coding, you can find me exploring new technologies &
              bioinformatics tools, reading FOSS article, contributing to
              open-source projects, or sharing my knowledge & experience through
              blogs and tutorials. I believe in continuous learning and pushing

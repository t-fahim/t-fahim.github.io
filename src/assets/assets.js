...
export const aboutInfo = [
  {
    ...
    title: "Innovative",
    description:
      "I love creating solutions to complex problems with cutting-edge technologies.",
    color: "text-purple",
  },
  {
    icon: FaPaintBrush,
    ...
    description:
      "User experience and beautiful design are at the heart of everything I create.",
    color: "text-pink",
  },
  {
    icon: FaCode,
...
export const skills = [
  {
    ...
    icon: FaDna,
    description:
      "Working with various bioinformatics tools and libraries to analyze biological data efficiently.",
  ...
  },
  {
    ...
    icon: FaBrain,
    description:
      "Building AI and ML models for data analysis, prediction, and automation.",
    tags: [
      "TensorFlow",
      "PyTorch",
      "Scikit-learn",
...
export const projects = [
  {
    title: "BAU VTH",
    description:
      "Developed a full-stack web application using with Django with tailwind as the frontend.",
    image: projectImg1,
  ...
  },
  {
    title: "RBGI",
    description:
      "Developed a full-stack web application using with PHP with tailwind as the frontend",
    image: projectImg4,
